...
function(a) {
    ...
    c.check = function() {
        ...
        if ("" !== d.replace(/\s/g, "")) {
            ...
            c.msg("Date is not in conformity with the format,please choose again"),
            1;
            if (f[0]) return c.elem[h.elemv] = "",
            c.msg("Date is not in the period of validity,please choose again"),
            1;
    ...
    c.viewDate = function(a, b, d) {
        ...
        c.ymd = f.ymd,
        h.year.value = c.ymd[0] + "y",
        h.month.value = c.digit(c.ymd[1] + 1) + "m",
        c.each(h.mms,
        function(a, b) {
    ...
    c.viewtb = function() {
        var a, b = [],
        f = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],  //"Sun", "Mon", "Tues", "Wednes", "Thurs", "Fri", "Satur"
        h = {},
        i = d[e]("table"),
        j = d[e]("thead");
    ...
    c.events = function() {
        ...
        e.hmss = ["hour", "minute", "second"], //"小时", "分钟", "秒数"
        e.hmsarr = [],
        c.msg = function(a, d) {
